...
import cl from './privacy-policy.module.scss'

const PrivacyPolicy = () => {
	return (
		<div className={cl.privacyWrapper}>
			<div className="container">
				<h1 className={cl.title}>Политика в отношении обработки персональных данных</h1>
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>1. Общие положения</h2>
					<p>
						...
						<br /> №152-ФЗ «О персональных данных» и определяет порядок обработки персональных данных и меры по
						обеспечению безопасности персональных данных, <br />
				...
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>2. Основные понятия, используемые в Политике</h2>
					<p>
					...
					<p>
						...
						определяемому Пользователю веб-сайта XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
					</p>
					<p>2.9. Пользователь – любой посетитель веб-сайта XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</p>
					<p>
				...
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>3. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
				...
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>4. Цели обработки персональных данных</h2>
					<p>
					...
					<p>
						...
						сообщений, направив Оператору письмо на адрес электронной почты XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX с
				...
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>5. Правовые основания обработки персональных данных</h2>
					<p>
						...
						XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX . Заполняя соответствующие формы и/или отправляя свои персональные
				...
				<div className={cl.contentWrapper}>
					...
					<p>
						...
						XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX с пометкой «Актуализация персональных данных».
					</p>
					<p>
						...
						на электронный адрес Оператора XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX с пометкой «Отзыв согласия на
						обработку персональных данных».
					</p>
				</div>

				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>7. Трансграничная передача персональных данных</h2>
					<p>
				...
				<div className={cl.contentWrapper}>
					<h2 className={cl.textTitle}>8. Заключительные положения</h2>
					<p>
